...
namespace predict_with_rest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var appId = "a775bd06-ad81-4353-b618-cff38076d707";

            // YOUR-PREDICTION-KEY: 32 character key.
            var predictionKey = "54376720bc6f495992dbea534be03b1c";

            // YOUR-PREDICTION-ENDPOINT: Example is "https://westus.api.cognitive.microsoft.com/"
            var predictionEndpoint = "https://rg-team19-luis.cognitiveservices.azure.com/";
